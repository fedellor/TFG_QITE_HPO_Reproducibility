#!/bin/bash
# ==============================================================================
# SCRIPT: Code/run_qite_qmio.sh
# DESCRIPCIÓN: Ejecución física del algoritmo cuántico avanzado VarQITE en la QPU real de Qmio.
#              Utiliza el hardware físico a través de QmioBackend y guarda resultados
#              en resultados_qite_qmio.csv.
# ==============================================================================
#SBATCH -J tfg_qite_qmio
#SBATCH -p qpu
#SBATCH -t 01:00:00
#SBATCH -c 8
#SBATCH --mem=250G
#SBATCH -o logs/qite_qmio_%j.out
#SBATCH -e logs/qite_qmio_%j.err
...
echo "=== [SLURM] VarQITE EN REAL QPU QMIO — 5 semillas ==="
...
echo "=== [SLURM] Finalizado VarQITE en la QPU de Qmio. Resultado: resultados_qite_qmio.csv ==="
